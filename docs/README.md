...
| 3 | **Bulk optimization** | [specs/2026-07-02-bulk-phase-2-promotion.md](specs/2026-07-02-bulk-phase-2-promotion.md) | ✅ Phase 2 done (2026-07-03) | **Top product priority (maintainer, 2026-07-02).** Design phase COMPLETE (all questions decided — [bulk-ui-design-options.md](bulk-ui-design-options.md)); Phase 2 production bulk shipped on the main route with ZIP export, folder import, remove+Undo, and bulk e2e coverage. Next: [Phase-2b left-panel spec](specs/2026-07-02-phase-2b-contextual-left-panel.md), then Phase 3 overrides polish (see [codec-options-model.md](codec-options-model.md) sequencing analysis). Multi-Format Compare follows bulk ([road-map.md](road-map.md)). |
...
| [codec-options-model.md](codec-options-model.md) | Design proposal for a unified codec-options model. Not started; includes the 2026-07-02 Phase-3 sequencing analysis (minimal slice first). | Working the options-model project or bulk Phase 3. | Progress on that project, or the codec option surface changes. |

...
- WebP 2 is experimental parity. Keep the bundled WASM path testable while the
  SvelteKit editor is matching existing behavior, but do not make public
  delivery guidance depend on it.

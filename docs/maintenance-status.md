...
- `d972760` Clean up custom element listeners
- `475a937` Disconnect custom element observers
- `a6e1de9` Guard expander transition cleanup
- `5ef6bd7` Dispose worker bridges on unmount
- `270fcdd` Tighten file drop handler type
- `980e87f` Guard editor async error updates
- `3f7bf84` Guard editor async undo updates
- `0854eb1` Guard app shell async updates
- `24ffe66` Clean up app shell listeners

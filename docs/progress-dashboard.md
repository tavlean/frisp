...
| Bulk backend foundation              |      68% | Framework-neutral helpers now cover import, injected MIME sniffing, settings lookup, queueing, per-job size state, export summaries, selection context, actions, processing, and URLs.                                                                                                  |

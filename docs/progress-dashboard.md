...
| Area                                 | Progress | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------ | -------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stabilization, CI, and security      |      96% | Audit is clean, CI covers Ubuntu, Windows, and macOS, WebP output plus saved WebP side settings import have automated local production-build smoke coverage, extensionless PNG input, offline app-shell reload, and service-worker-disabled app-shell loading are covered in browser smoke, saved-settings storage is failure-tolerant, side output reset behavior is covered, compressed output filenames are safer against path-like and reserved names, and built-in decode releases ImageBitmap resources.                                                                                                                                                                                                                                                    |

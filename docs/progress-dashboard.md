...
| Area                                 | Progress | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------ | -------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stabilization, CI, and security      |      94% | Audit is clean, CI covers Ubuntu, Windows, and macOS, WebP output plus saved WebP side settings import have automated local production-build smoke coverage, extensionless PNG input and offline app-shell reload are covered in browser smoke, saved-settings storage is failure-tolerant, side output reset behavior is covered, compressed output filenames are safer, and built-in decode releases ImageBitmap resources.                                                                                                                                              |
| Documentation and handoff clarity    |      84% | Core docs exist. Progress, roadmap, issue list, project identity, codec provenance, QA, browser smoke, Svelte migration context, and maintenance status are tracked.                                                                                                                                                                                                                                                                                                                                                                                                       |
| Bulk backend foundation              |      86% | Framework-neutral helpers now cover import, injected MIME sniffing, settings lookup, safe settings-change workflows, queueing, queue-state selectors, full queue draining, active/incomplete requeueing, active-job cancellation, derived session counters, drift-tolerant queue scheduling and transitions, metadata-only session snapshots with validated parsing/restoration, per-job size state, selected export plans, export summaries, stale export guards, selected-job detail, strip and session summary view models, command action state, processing, and URLs. |

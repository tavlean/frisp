...
| Bulk backend foundation              |      67% | Framework-neutral helpers now cover import, injected MIME sniffing, settings lookup, queueing, per-job size state, summaries, selection context, actions, processing, and URLs.                                                                                                         |

...
| Area                                 | Progress | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------ | -------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stabilization, CI, and security      |      93% | Audit is clean, CI covers Ubuntu, Windows, and macOS, WebP output plus saved WebP side settings have automated local production-build smoke coverage, extensionless PNG input and offline app-shell reload are covered in browser smoke, saved-settings storage is failure-tolerant, side output reset behavior is covered, compressed output filenames are safer, and built-in decode releases ImageBitmap resources.                                                                         |
| Documentation and handoff clarity    |      83% | Core docs exist. Progress, roadmap, issue list, codec provenance, QA, browser smoke, Svelte migration context, and maintenance status are tracked.                                                                                                                                                                                                                                                                                                                                             |
| Bulk backend foundation              |      82% | Framework-neutral helpers now cover import, injected MIME sniffing, settings lookup, safe settings-change workflows, queueing, full queue draining, active/incomplete requeueing, active-job cancellation, derived session counters, drift-tolerant queue scheduling and transitions, metadata-only session snapshots with validated parsing, per-job size state, selected export plans, export summaries, stale export guards, selection context, command action state, processing, and URLs. |
| Repo simplification                  |      37% | Dependency/script cleanup, storage centralization, storage failure handling, result-cache coverage, and shared/service-worker type cleanup have reduced some legacy loose typing and scattered browser APIs. Codec surface, Preact coupling, and custom Rollup complexity still remain.                                                                                                                                                                                                        |
| Svelte/SvelteKit migration readiness |      26% | Shared pipeline and bulk logic extraction has started, and the current Svelte 5/SvelteKit migration guidance is documented. UI migration should wait until behavior is better tested.                                                                                                                                                                                                                                                                                                          |

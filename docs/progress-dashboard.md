...
| Area                                 | Progress | State                                                                                                                                                                                                                                                                                   |
| ------------------------------------ | -------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stabilization, CI, and security      |      91% | Audit is clean, CI covers Ubuntu, Windows, and macOS, WebP output plus saved WebP side settings have automated local production-build smoke coverage, saved-settings storage is failure-tolerant, side output reset behavior is covered, and compressed output filenames are safer.     |
...
| Bulk backend foundation              |      70% | Framework-neutral helpers now cover import, injected MIME sniffing, settings lookup, queueing, per-job size state, selected export plans, export summaries, selection context, actions, processing, and URLs.                                                                           |

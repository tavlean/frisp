...
| Repo simplification                  |      48% | Dependency/script cleanup, Node 24 baseline alignment, storage centralization, storage failure handling, result-cache coverage, shared/service-worker type cleanup, static-build utility cleanup, tested single-image work planning/job derivation/display/source/preprocessor/saved-settings/side-state helpers, and removal of maintained app/lib TS suppressions have reduced some legacy loose typing and scattered browser APIs. Codec surface, Preact coupling, and custom Rollup complexity still remain.                                                                                                                                                                                                                                                  |
| Svelte/SvelteKit migration readiness |      34% | Shared pipeline, single-image work planning/job derivation/source defaults/preprocessor changes/display render selectors/side-state helpers, and bulk logic extraction have started, and the current Svelte 5/SvelteKit migration guidance is documented. UI migration should wait until behavior is better tested.                                                                                                                                                                                                                                                                                                                                                                                                                                               |

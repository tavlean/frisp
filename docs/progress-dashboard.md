...
| Bulk backend foundation              |      64% | Framework-neutral helpers now cover import, settings lookup, queueing, summaries, selection context, actions, processing, and URLs. |

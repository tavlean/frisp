...
| Use case                          | Recommended (Presk controls)                                 |
| --------------------------------- | ------------------------------------------------------------ |
...
**Current Presk default:** lossy, Quality 80, Effort 6 (updated 2026-06-03 from the upstream-Squoosh 75/4 — the "Web photo" recommendation below is now the shipped default).
...
**Current Presk default:** lossy, Quality 50, Effort 4, 4:2:0, Tuning Auto.
...
**Current Presk default:** Quality 75, Progressive on, Trellis multipass off, quant table ImageMagick.
...
**Current Presk default:** Effort 2, Interlace off.
...
**Current Presk default:** Lanczos3, Premultiply on, Linear RGB on.
...
**Current Presk default:** Colors 256, Dithering 1.0.
